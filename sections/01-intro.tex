...
Second, since users may update data individually,  they cannot see all the updates, thus leading to corrupted low-quality data. Hence, it is significant to support atomic writes to achieve high quality data. \cc{any more challenge (efficiency problem) induced by this, and can be addressed by our cache?}
%元数据读取时间长
